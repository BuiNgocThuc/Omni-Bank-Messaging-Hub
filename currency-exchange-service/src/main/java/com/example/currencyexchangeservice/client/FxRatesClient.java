package com.example.currencyexchangeservice.client;

import com.example.currencyexchangeservice.dto.FxRatesResponse;
...
public class FxRatesClient {
    ...
    public FxRatesResponse fetchRate(String base, String target, BigDecimal amount) {
    ...
    public BigDecimal getRate(String base, String target, BigDecimal amount) {
